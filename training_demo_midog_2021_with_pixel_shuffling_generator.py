...
The image generator uses the PixelShuffle-based generator named AbsorbanceImGenerator.
"""
import logging
...
def _train_model(sample_lists_by_domain_idx: Dict[int, List[Sample]]) -> None:
    ...
    experiment_name = (
        ...
        + f"bs_{BATCH_SIZE_PER_GPU}_samples_w_{loss_string_from_weight_dict(loss_weights_by_name)}_MIDOG_v1.1"
    )
    ...
    training_module = MutliClassTrainingModule(
        ...
        num_attribute_enc_out_chans=48,
        ...
        generator_type=GeneratorType.WithPixelShuffle,
