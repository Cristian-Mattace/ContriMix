"""A scripts to train a Contrimix model for TCGA dataset using Distributed Data Parallel (DDP).
...
def main():
    """Demo scripts for training, evaluation with TCGA."""
    ...
    tcga_dataset = TCGADataset(dataset_dir=all_dataset_dir / "contrimix_demo/", use_full_size=True)
    ...
    algorithm = initialize_algorithm(
        ...
        loss_kwargs={
            ...
            "ddp_local_rank": FLAGS.local_rank,  # Useful for saving debug images.
        },
