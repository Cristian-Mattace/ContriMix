...
def main():
    ...
    config_dict: Dict[str, Any] = {
        ...
        "batch_size": 48 * num_of_available_devices(),
        "run_on_cluster": FLAGS.run_on_cluster,
        "group_sampler_parameters": {"chunk_size": 4},
        "uniform_over_groups": True,  #
        "distinct_groups": True,  # If True, enforce groups sampled per batch are distinct.
        "n_groups_per_batch": 12 * num_of_available_devices(),  # There are 1139 groups in the RxRx1 for 1139 treatments
