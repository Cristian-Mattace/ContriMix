"""A sripts to obtain the baseline for the RxRx1 dataset.
...
def main():
    ...
    print("Training Contrimix encoders for RxRx1 with DDP.")
    ...
    rxrx1_dataset = RxRx1Dataset(
        dataset_dir=all_dataset_dir / "rxrx1_v1.0/",
    ...
    config_dict: Dict[str, Any] = {
        ...
        "weight_warm_up_steps": 0,
        "scheduler": "StepLR",
        "scheduler_kwargs": {"verbose": True, "step_size": 3000, "gamma": 0.9},
    ...
    algorithm = initialize_algorithm(
        ...
        loss_weights_by_name={
            "attr_cons_weight": 0.01,
            "attr_similarity_weight": 0.04,
            "self_recon_weight": 0.65,
            "cont_cons_weight": 0.30,
        },
